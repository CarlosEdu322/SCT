...
( -- lista de atributos
NroTramite int IDENTITY(1,1) PRIMARY KEY,
Tipo varchar(100),
-- especificacion de claves
)
go
...
( -- lista de atributos
NroRequisito int IDENTITY(1,1) PRIMARY KEY,
...
NroTramite int,
NroRequisito int,
foreign key (NroTramite) references TTramite(NroTramite),
foreign key (NroRequisito) references TRequisito(NroRequisito)
)
...
insert into TTramite values ('Nombramiento de Asesor e Inscripcion de Plan de Tesis')
insert into TTramite values ('Solicitar Nombramiento de la Comision Revisora y su posterior Revision')
insert into TTramite values ('Solicitar Nombramiento de dictaminadores de Tesis y su posterior Revision')
insert into TTramite values ('Determinacion de Fecha, Hora y Lugar para Sustentacion de Tesis')


insert into TRequisito values ('Solicitud Dirigida al Rector')
insert into TRequisito values ('Dos Ejemplares de Plan de Tesis refrendado por el Asesor')
insert into TRequisito values ('Carta de Aceptacion del Asesor')
insert into TRequisito values ('Ficha de Seguimiento Academico')
insert into TRequisito values ('Informe del Asesor')
insert into TRequisito values ('Resolucion de Aprobacion de Expediente de Titulo')
insert into TRequisito values ('Dos Ejemplares de Tesis Anillado')
insert into TRequisito values ('Certificado de Originalidad de la Tesis, firmado por el Asesor')
insert into TRequisito values ('Pago Por Derechos De Tramite')
insert into TRequisito values ('Copia de Resolucion de Aprobacion de Dictamen de Tesis')
insert into TRequisito values ('05 ejemplares de tesis ')

insert into TRequisitoXTramite values('1' ,'1')
insert into TRequisitoXTramite values('1' ,'2')
insert into TRequisitoXTramite values('1' ,'3')
insert into TRequisitoXTramite values('1' ,'4')

insert into TRequisitoXTramite values('2' ,'1')
insert into TRequisitoXTramite values('2' ,'2')
insert into TRequisitoXTramite values('2' ,'3')

select * from TRequisitoXTramite where NroTramite='2'

insert into TRequisitoXTramite values('3' ,'1')
insert into TRequisitoXTramite values('3' ,'5')
insert into TRequisitoXTramite values('3' ,'6')
insert into TRequisitoXTramite values('3' ,'7')
insert into TRequisitoXTramite values('3' ,'8')
insert into TRequisitoXTramite values('3' ,'9')

insert into TRequisitoXTramite values('4' ,'1')
insert into TRequisitoXTramite values('4' ,'9')
insert into TRequisitoXTramite values('4' ,'10')
